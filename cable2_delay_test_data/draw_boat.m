function [h] = draw_boat(h,s,x,y,a_b,a_r,a_s,color)
...
%draw lines
line([p2(1) p1(1)],[p2(2) p1(2)],'color',color);
line([p3(1) p1(1)],[p3(2) p1(2)],'color',color);
line([p2(1) p3(1)],[p2(2) p3(2)],'color',color);
line([pr1(1) pr2(1)],[pr1(2) pr2(2)],'color',color);   %rudder
line([x ps(1)],[y ps(2)],'color',color) ;      %sail
